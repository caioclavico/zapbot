...
(def ^:private comandos
  [{:emoji "🤡" :uso "piada"              :desc "Conta uma piada aleatória"}
   ...
   {:emoji "⚡" :uso "pokemon [liga [nome|time <n1,n2,n3>]|inicial|cacar|treinador|pokedex [n]|time [csv]|trocar <n>|equipar|removergolpe <n>|doar|joy <n,n,...>|atacar <1-4>|defender|curar|pocao|sair]" :desc "Batalhe e capture por bioma, troque uma vez no PvE, complete sua Pokédex (com <n>, a ficha completa do enésimo do seu time), equipe itens e evolua com XP"}
