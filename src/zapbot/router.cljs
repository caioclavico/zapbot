...
(def ^:private comandos
  [{:emoji "🤡" :uso "piada"              :desc "Conta uma piada aleatória"}
   ...
   {:emoji "⚡" :uso "pokemon [inicial|cacar|pokedex|time|escolher|equipar|doar|joy <n>|atacar <1-4>|defender|curar|pocao|sair]" :desc "Batalhe e capture por bioma, complete sua Pokédex, equipe itens e evolua com XP"}
