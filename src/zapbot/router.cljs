...
(def ^:private comandos
  [{:emoji "🤡" :uso "piada"              :desc "Conta uma piada aleatória"}
   ...
   {:emoji "⚡" :uso "pokemon [inicial|cacar|time|escolher|atacar <1-4>|defender|curar|pocao|sair]" :desc "Escolha seu inicial, capture pokémons caçando, e batalhe com seu time real (não sorteado): golpes via PokeAPI, cure status ou recupere HP (ver !loja) a qualquer hora"}
