...
(def ^:private changelog-ultima-versao
  [(str "Filtros combináveis por tipo, nome e nível no time: " config/prefix "pokemon time fogo nivel 25")
   "A visualização do time envia no máximo duas páginas para não lotar o chat de imagens"
  (str "Os mesmos filtros combináveis funcionam na Pokédex pessoal: " config/prefix "pokemon pokedex char fogo nivel 25")
